      ...
      >
        ...
        >
          ...
          >
            ...
            <a
              href="https://www.cookieyes.com/category/blog/"
              data-navlink="1"
              style={{
                display: "flex",
                alignItems: "center",
          ...
          >
            ...
            <a
              ...
              data-nav-gh="1"
              aria-label="GitHub repository, 10k+ downloads"
              className="scp1"
              style={{
                display: "flex",
                flexDirection: "row",
            ...
            >
              ...
              {/* Combined npm downloads across the published packages, rounded down so it
                  stays true as the figure grows. Verify with the npm downloads API before
                  raising it. */}
              <span
                data-nav-dl="1"
                style={{
                  marginLeft: "var(--cy-space-8)",
                  paddingLeft: "var(--cy-space-8)",
            ...
            {/* Dark-mode switch, between GitHub and search, as the design's nav has it.
                The same component the docs header uses, so one click sets the preference
                for the whole site. */}
            <ThemeToggle className="cy-nav-theme" />{" "}
            <div
              data-nav-search="1"
              className="scp2"
              style={{
